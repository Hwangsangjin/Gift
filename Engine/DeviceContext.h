...
public:
	...
	void SetTexture(const VertexShaderPtr& vertex_shader, const TexturePtr* texture_list, unsigned int texture_size);
	void SetTexture(const PixelShaderPtr& pixel_shader, const TexturePtr* texture_list, unsigned int texture_size);
